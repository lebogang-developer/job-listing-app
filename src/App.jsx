          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
            ...
            <div className='bg-white rounded-xl shadow-md relative'>
              <div className='p-4'>
                ...
                <div className='mb-5'>
                  ...
                  in Gauten, JHB. The ideal candidate will have strong skills in
                  HTML, CSS, and JavaScript...
                </div>

                <h3 className='text-indigo-500 mb-2'>R70 - R80K / Year</h3>
            ...
            <div className='bg-white rounded-xl shadow-md relative'>
              <div className='p-4'>
                ...
                <h3 className='text-indigo-500 mb-2'>R70K - R80K / Year</h3>
